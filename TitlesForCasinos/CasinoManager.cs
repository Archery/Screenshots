...
namespace TitlesForCasinos {
    public class CasinoManager {
        ...
        public CasinoManager() {
            this.WorkingDir = new DirectoryInfo(Properties.Settings.Default.WorkingDir);
            this.DataDir = new DirectoryInfo(Properties.Settings.Default.DataDir);
            this.ScreenshotsDir = new DirectoryInfo(Properties.Settings.Default.ScreenshotsDir);
